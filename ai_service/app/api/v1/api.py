...
from app.api.v1.routers.repomind_proxy import router as repomind_proxy_router
...
# RepoMind Proxy (bridges Java REST calls to RepoMind MCP stdio)
api_router.include_router(repomind_proxy_router)
