...
function AISpecGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    const request = {
      domain:
        formData.domain === "custom" ? formData.customDomain : formData.domain,
  ...
  const handleUseSpec = (spec) => {
    if (spec.generatedSpec) {
      ...
      setSpecText(
        typeof spec.generatedSpec === "string"
          ? spec.generatedSpec
  ...
  return (
    <div className="ai-spec-generator">
      <div className="generator-header">
        ...
        <p>
          Generate complete OpenAPI specifications from high-level descriptions
        </p>
      </div>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleInputChange("complexityLevel", e.target.value)
              }
            >
            ...
            <div className="checkbox-group">
              ...
              <label className="checkbox-item">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("includeValidation", e.target.checked)
                  }
                />
              ...
              <label className="checkbox-item">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("includeDocumentation", e.target.checked)
                  }
                />
      ...
      {isAiProcessing && (
        <div className="generator-loading">
          ...
          <small>
            This may take up to 2 minutes for complex specifications
          </small>
        </div>
      )}
