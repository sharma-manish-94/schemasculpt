...
const SecurityAnalysisTab = ({ specContent }) => {
    ...
    const handleAnalyze = async (forceRefresh = false) => {
        ...
        try {
            ...
            const securitySuggestions = suggestions ? getSecuritySuggestions(suggestions) : null;

            console.log(`Running security analysis with ${securitySuggestions?.length || 0} security-related validation suggestions`);
        ...
        <div className="security-analysis-tab">
            <div className="security-header">
                ...
                <p className="security-description">
                    Comprehensive multi-agent security analysis covering OWASP API Security Top 10 2023
                </p>
            </div>
                                ...
                                <div className="score-main">
                                    ...
                                    <div className="score-details">
                                        ...
                                        <div
                                            ...
                                            style={{ backgroundColor: getRiskLevelColor(report.risk_level) }}
                                        >
            ...
            {!report && !analyzing && !error && (
                <div className="security-empty-state">
                    ...
                    <p>Run a security analysis to identify vulnerabilities and compliance issues</p>
