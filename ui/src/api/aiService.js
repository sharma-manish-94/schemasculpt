...
export const processSpecification = async (request) => {
    ...
    try {
        const response = await axios.post(`${API_CONFIG.BASE_URL}/ai/process`, request);
        return {
            success: true,
            data: response.data
        };
...
export const processSpecificationStreaming = async (request, onChunk, onComplete, onError) => {
    if (!request || !request.operationType) {
        onError?.({
            success: false,
            error: "Operation type is required",
    ...
    try {
        const eventSource = new EventSource(`${API_CONFIG.BASE_URL}/ai/process/stream`, {
            method: 'POST',
            headers: {
...
export const generateSpecification = async (request) => {
    ...
    try {
        const response = await axios.post(`${API_CONFIG.BASE_URL}/ai/generate`, request);
        return {
            success: true,
            data: response.data
        };
...
export const getSpecificAgentStatus = async (agentName) => {
    ...
    try {
        const response = await axios.get(`${API_CONFIG.BASE_URL}/ai/agents/${agentName}/status`);
        return {
            success: true,
            data: response.data
        };
    } catch (error) {
        return handleApiError(error, `Failed to fetch status for agent ${agentName}`);
    }
};
...
export const restartAgent = async (agentName) => {
    ...
    try {
        const response = await axios.post(`${API_CONFIG.BASE_URL}/ai/agents/${agentName}/restart`);
        return {
            success: true,
            data: response.data
        };
...
export const getAgentsPerformance = async () => {
    try {
        const response = await axios.get(`${API_CONFIG.BASE_URL}/ai/agents/performance`);
        return {
            success: true,
            data: response.data
        };
...
export const getAgentsCapabilities = async () => {
    try {
        const response = await axios.get(`${API_CONFIG.BASE_URL}/ai/agents/capabilities`);
        return {
            success: true,
            data: response.data
        };
...
// AI Prompt Service
export const generateIntelligentPrompt = async (requestData, contextId = null) => {
    if (!requestData) {
        return {
            success: false,
...
export const getPromptStatistics = async () => {
    try {
        const response = await axios.get(`${API_CONFIG.BASE_URL}/ai/prompt/statistics`);
        return {
            success: true,
            data: response.data
        };
...
export const usePromptTemplate = async (templateName, templateVariables) => {
    ...
    try {
        ...
        return handleApiError(error, `Failed to use prompt template ${templateName}`);
    }
};

export const getAvailableTemplates = async () => {
    try {
        const response = await axios.get(`${API_CONFIG.BASE_URL}/ai/prompt/templates`);
        return {
            success: true,
            data: response.data
        };
...
export const optimizePrompt = async (promptData) => {
    ...
    try {
        const response = await axios.post(`${API_CONFIG.BASE_URL}/ai/prompt/optimize`, promptData);
        return {
            success: true,
            data: response.data
        };
