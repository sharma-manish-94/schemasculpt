...
const DescriptionQualityPanel = ({ results, overallScore, patches, onApplyPatches, isLoading }) => {
    ...
    if (!results || results.length === 0) {
        return (
            <div className="description-quality-empty">
                ...
                <p className="empty-hint">Click "Analyze Descriptions" to check quality.</p>
            </div>
        );
    }
            ...
            <div className="quality-header">
                <div className="overall-score">
                    <div className="score-circle" style={{
                        borderColor: overallScore >= 90 ? '#10b981' :
                                ...
                                <div className="item-info">
                                    ...
                                    <div className="item-details">
                                        ...
                                        <div className="item-meta">
                                            <span className="item-score">Score: {result.qualityScore}</span>
