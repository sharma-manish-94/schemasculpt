...
COMMENT ON TABLE users IS 'GitHub authenticated users';
COMMENT ON TABLE projects IS 'User projects containing OpenAPI specifications';
COMMENT ON TABLE specifications IS 'Versioned OpenAPI specification content';
COMMENT ON TABLE validation_snapshots IS 'Historical validation results for specifications';

COMMENT ON COLUMN specifications.is_current IS 'Indicates the current/active version of the specification';
COMMENT ON COLUMN specifications.spec_format IS 'Format of the spec: json or yaml';
