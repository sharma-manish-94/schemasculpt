...
/**
 * Generic interface for OpenAPI specification analyzers. Follows the Strategy pattern with
 * type-safe return values.
 *
 * <p>Each analyzer implements a specific analysis algorithm (e.g., dependency graph, taint
 * analysis, schema similarity) and returns a strongly-typed result.
 *
