...
public class TreeShakingService {
    ...
    public OpenAPI extractOperationWithDependencies(OpenAPI fullSpec, String path, String method) {
        ...
        try {
            ...
            if (!allDependencies.isEmpty() && cleanFullSpec.getComponents() != null &&
    ...
    private OpenAPI createFallbackSpec(OpenAPI fullSpec, String path, String method, Operation operation, Set<String> allDependencies) {
    ...
    private Set<String> findDependencies(Operation operation, OpenAPI fullSpec) {
        ...
        while (!nodesToVisit.isEmpty()) {
            ...
            if (currentNode.isObject()) {
                currentNode.properties().forEach(property -> {
