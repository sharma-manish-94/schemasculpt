...
import io.github.sharma_manish_94.schemasculpt_api.service.HardeningService;
...
public class HardeningController {
    ...
    public ResponseEntity<HardeningResponse> hardenOperation(
            ...
            @RequestBody HardenOperationRequest request) {

        log.info("Hardening operation {} {} for session {}",
                request.method(), request.path(), sessionId);
    ...
    public ResponseEntity<HardeningResponse> addOAuth2Security(
        ...
        HardenOperationRequest hardenRequest = new HardenOperationRequest(
            path,
            method,
            List.of("oauth2"),
    ...
    public ResponseEntity<HardeningResponse> hardenOperationComplete(
        ...
        HardenOperationRequest hardenRequest = new HardenOperationRequest(
            path,
            method,
            List.of("oauth2", "rate-limiting", "caching", "idempotency", "validation", "error-handling"),
            new HardenOperationRequest.HardeningOptions(
    ...
    public ResponseEntity<Map<String, Object>> getAvailablePatterns() {
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "recommendations", Map.of(
                ...
                "POST", List.of("oauth2", "rate-limiting", "idempotency", "validation", "error-handling"),
                "PUT", List.of("oauth2", "rate-limiting", "idempotency", "validation", "error-handling"),
                "PATCH", List.of("oauth2", "rate-limiting", "idempotency", "validation", "error-handling"),
