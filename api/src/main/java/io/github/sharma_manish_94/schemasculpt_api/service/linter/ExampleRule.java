...
/**
 * Linter rule that checks for missing examples in schemas and responses. Examples greatly improve
...
public class ExampleRule implements LinterRule {
  ...
  private boolean shouldHaveResponseExample(String mediaType, MediaType content) {
    ...
    return mediaType.contains("json") || mediaType.contains("xml") || mediaType.contains("yaml");
  }
