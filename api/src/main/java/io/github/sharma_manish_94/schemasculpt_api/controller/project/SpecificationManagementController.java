...
public class SpecificationManagementController {
    ...
    public ResponseEntity<SpecificationDTO> saveSpecification(
        ...
        Specification spec = specificationService.saveSpecification(
            projectId,
            principal.getUserId(),
            request.specContent(),
            request.specFormat(),
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
            .body(new SpecificationDTO(spec));
    }
    ...
    public ResponseEntity<SpecificationDetailDTO> getCurrentSpecification(
        ...
        Specification spec = specificationService.getCurrentSpecification(
            projectId,
            principal.getUserId()
        );
    ...
    public ResponseEntity<List<SpecificationDTO>> getSpecificationVersions(
        ...
        List<SpecificationDTO> versions = specificationService
            .getSpecificationVersions(projectId, principal.getUserId())
            .stream()
    ...
    public ResponseEntity<SpecificationDetailDTO> getSpecificationByVersion(
        ...
        Specification spec = specificationService.getSpecificationByVersion(
            projectId,
            version,
            principal.getUserId()
        );
    ...
    public ResponseEntity<SpecificationDTO> revertToVersion(
        ...
        Specification spec = specificationService.revertToVersion(
            projectId,
            version,
            principal.getUserId(),
            commitMessage
