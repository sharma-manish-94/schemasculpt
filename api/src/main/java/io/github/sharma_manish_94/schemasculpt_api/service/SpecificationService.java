...
public class SpecificationService {
    ...
    public Specification saveSpecification(
        ...
        List<Specification> existingSpecs = specificationRepository
    ...
    public Specification getSpecificationByVersion(Long projectId, String version, Long userId) {
        ...
        return specificationRepository.findByProjectIdAndVersion(projectId, version)
     ...
     */
    @Transactional
    public Specification revertToVersion(Long projectId, String version, Long userId, String commitMessage) {
        ...
        String revertMessage = commitMessage != null ? commitMessage :
            "Reverted to version " + version;

        return saveSpecification(
            projectId,
            userId,
            targetSpec.getSpecContent(),
            targetSpec.getSpecFormat(),
            revertMessage
        );
    }
