...
/**
 * Linter rule that validates API path naming conventions following REST best practices.
 * Ensures paths use kebab-case, no trailing slashes, and proper resource naming.
 */
@Component
public class PathNamingRule implements LinterRule {
    ...
    private boolean isLikelyResourceCollection(String segment, int index, String[] segments) {
        ...
        boolean followedByParameter = index + 1 < segments.length &&
    ...
    private boolean isProbablySingular(String segment) {
        ...
        String[] irregularPlurals = {"children", "people", "men", "women", "feet", "teeth", "mice", "data"};
