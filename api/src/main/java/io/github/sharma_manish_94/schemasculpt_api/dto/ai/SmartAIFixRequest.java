...
/**
 * Request for smart AI fix that intelligently chooses between patches and full regeneration.
 * Uses snake_case for Python compatibility.
 */
...
public record SmartAIFixRequest(
        ...
        @JsonProperty("force_full_regeneration")
        Boolean forceFullRegeneration
) {
    /**
