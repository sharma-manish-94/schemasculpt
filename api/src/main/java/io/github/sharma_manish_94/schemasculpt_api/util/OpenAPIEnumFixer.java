 ...
 *
 * The Swagger parser stores enums as uppercase in the model objects,
 * but the OpenAPI spec requires lowercase values. This utility fixes
 * the JSON after serialization.
 */
