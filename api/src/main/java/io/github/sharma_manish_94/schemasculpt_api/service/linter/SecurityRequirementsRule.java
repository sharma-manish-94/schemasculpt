...
/**
 * Linter rule that checks if operations have appropriate security requirements.
 * Ensures API security is properly defined and applied.
 */
@Component
public class SecurityRequirementsRule implements LinterRule {
    ...
    private List<ValidationSuggestion> checkOperationSecurity(OpenAPI openApi, boolean hasSecuritySchemes) {
        List<ValidationSuggestion> suggestions = new ArrayList<>();
