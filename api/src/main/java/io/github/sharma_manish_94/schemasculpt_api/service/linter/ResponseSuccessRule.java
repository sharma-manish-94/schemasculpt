...
/**
 * Linter rule that ensures operations have at least one success response (2xx or 3xx).
 * Based on Spectral's operation-success-response rule.
 */
@Component
